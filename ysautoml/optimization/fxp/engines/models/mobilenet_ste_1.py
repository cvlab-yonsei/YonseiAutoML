...
__all__ = ['MobileNetV2', 'mobilenet_ste_1']
...
class ConvBNReLU(nn.Sequential):
    def __init__(self, in_planes, out_planes, kernel_size=3, stride=1, groups=1, norm_layer=None, initial=False, symmetric=False):
        ...
        if initial:
            ...
            super(ConvBNReLU, self).__init__(
                DSQConv_a_mobile_DW_1(in_planes, out_planes, kernel_size, stride, padding, groups=groups,
...
def mobilenet_ste_1(pretrained=False, progress=True, **kwargs):
    """
