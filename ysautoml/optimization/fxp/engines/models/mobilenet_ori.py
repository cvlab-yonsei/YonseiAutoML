...
from .modules import DSQConv_a, DSQConv_8bit, DSQLinear, DSQConv_a_mobile, Conv_vis

__all__ = ['MobileNetV2', 'mobilenet_ori']
...
class ConvBNReLU(nn.Sequential):
    def __init__(self, in_planes, out_planes, kernel_size=3, stride=1, groups=1, norm_layer=None, initial=False, symmetric=False):
        ...
        super(ConvBNReLU, self).__init__(
            Conv_vis(in_planes, out_planes, kernel_size, stride, padding, groups=groups,
                      bias=False),
...
class InvertedResidual(nn.Module):
    def __init__(self, inp, oup, stride, expand_ratio, norm_layer=None, first_layer=False):
        ...
        layers.extend([
            ...
            # pw-linear
            Conv_vis(hidden_dim, oup, 1, 1, 0, bias=False),
            norm_layer(oup),
        ])
