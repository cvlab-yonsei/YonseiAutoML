...
def parse_args(parser):
    parser.add_argument('--dataset', default='nyusp', type=str, help='')
...
def main(params):
    ...
    kwargs['weight_args']['dataset_str'] = params.dataset
    
    # prepare dataloaders
    nyuv2_train_set = NYUv2(root=params.dataset_path, mode='train', augmentation=params.aug)
    nyuv2_val_set = NYUv2(root=params.dataset_path, mode='val', augmentation=False)
    ...
    if params.mode == 'train':
        NYUmodel.train(train_dataloaders=nyuv2_train_loader,
                       val_dataloaders=nyuv2_val_loader,
                       test_dataloaders=nyuv2_test_loader,
